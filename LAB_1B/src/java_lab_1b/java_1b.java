	...
	public static void main(String args[])
	{
		...
		while(true)
		{
			...
			if (ch==1)
			{
				...
				si = new java_1b(sname, sadd,sphoneno, semailid);	
			}
			else 
			{
				
				si = new java_1b(sname, sadd);
			}
			...
			System.out.println("Would you like to continue (1=yes and 0=no : ");
			int ch2=sc.nextInt();
			if(ch2==0)
				break;
